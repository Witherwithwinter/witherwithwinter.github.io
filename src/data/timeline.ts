...
export const timelineData: TimelineItem[] = [
	{
		...
		location: "Hubei",
		organization: "Hubei Normal University",
	...
	},
	{
		...
		endDate: "2026-01-11",
		skills: ["Astro", "Git"],
		achievements: ["Experienced modern frontend development by myself"],
		links: [
			{
	...
	// },
	{
		id: "first-icpc-invitation",
		title: "First ICPC Invitational Contest",
		description:
			"Participated in The 2025 ICPC China National Invitational Programming Contest(Nanchang).",
		type: "achievement",
	...
	{
		id: "first-ccpc-invitation",
		title: "First CCPC Invitational Contest",
		description:
			"Participated in The 2025 CCPC National Invitational Programming Contest(Fuzhou).",
		type: "achievement",
		...
		achievements: [
			...
			"Improved cooperation ability",
		],
		icon: "material-symbols:emoji-events",
		color: "#7C3AED",
	},
	{
		id: "first-icpc-regional",
		title: "First ICPC Regional Contest",
		description:
			"Participated in The 2025 ICPC Asia Shanghai Regional Contest",
		type: "achievement",
		...
		skills: ["C++", "Algorithms", "Data Structures"],
		achievements: ['Won "Iron " prize in Shanghai', "Closer to the medal"],
		icon: "material-symbols:emoji-events",
		color: "#7C3AED",
	},
];
